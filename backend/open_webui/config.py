...
OLLAMA_API_BASE_URL = os.environ.get(
    'OLLAMA_API_BASE_URL',
    os.environ.get('MODEL_PROVIDER_OLLAMA_API_URL', 'http://localhost:11434/api'),
)

OLLAMA_BASE_URL = os.environ.get('OLLAMA_BASE_URL', os.environ.get('MODEL_PROVIDER_OLLAMA_URL', ''))
if OLLAMA_BASE_URL:
...
if ENV == 'prod':
    if OLLAMA_BASE_URL == '/ollama' and not K8S_FLAG:
        ...
        OLLAMA_BASE_URL = os.environ.get(
            'OLLAMA_K8S_BASE_URL',
            'http://ollama-service.local-ai-hub.svc.cluster.local:11434',
        )
...
OLLAMA_BASE_URLS = os.environ.get('OLLAMA_BASE_URLS', os.environ.get('MODEL_PROVIDER_OLLAMA_URLS', ''))
...
OPENAI_API_KEY = os.environ.get('OPENAI_API_KEY', os.environ.get('MODEL_PROVIDER_OPENAI_API_KEY', ''))
OPENAI_API_BASE_URL = os.environ.get(
    'OPENAI_API_BASE_URL',
    os.environ.get('MODEL_PROVIDER_OPENAI_API_BASE_URL', ''),
)
...
OPENAI_API_KEYS = os.environ.get('OPENAI_API_KEYS', os.environ.get('MODEL_PROVIDER_OPENAI_API_KEYS', ''))
...
OPENAI_API_BASE_URLS = os.environ.get(
    ...
    os.environ.get('MODEL_PROVIDER_OPENAI_API_BASE_URLS', ''),
)

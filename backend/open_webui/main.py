...
from open_webui.utils.branding import (
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for the active WebUI deployment.
...
async def get_manifest_json():
    if app.state.EXTERNAL_PWA_MANIFEST_URL:
        ...
        return {
            ...
            'description': manifest_description(app.state.WEBUI_NAME),
            'start_url': '/',
            'display': 'standalone',

...
DATABASE_USER = os.environ.get('DATABASE_USER', os.environ.get('APP_DATABASE_USER'))
DATABASE_PASSWORD = os.environ.get('DATABASE_PASSWORD', os.environ.get('APP_DATABASE_PASSWORD'))
...
DB_VARS = {
    ...
    'db_host': os.environ.get('DATABASE_HOST', os.environ.get('APP_DATABASE_HOST')),
    'db_port': os.environ.get('DATABASE_PORT', os.environ.get('APP_DATABASE_PORT')),
    'db_name': os.environ.get('DATABASE_NAME', os.environ.get('APP_DATABASE_NAME')),
}
...
REDIS_URL = os.environ.get('REDIS_URL', os.environ.get('APP_REDIS_URL', ''))
REDIS_CLUSTER = os.environ.get('REDIS_CLUSTER', 'False').lower() == 'true'

REDIS_KEY_PREFIX = os.environ.get('REDIS_KEY_PREFIX', PROJECT_SLUG)
...
OTEL_SERVICE_NAME = os.environ.get('OTEL_SERVICE_NAME', PROJECT_SLUG)
